"""
Generate a tube-label CSV for the cDNA conversion protocol (cDNA_Dynamic_v10.py).
...
The planning logic below is copied VERBATIM from cDNA_Dynamic_v10.py (plan_sample,
...
# --- planning logic (mirrors cDNA_Dynamic_v10.py) ----------------------------
...
# --- water provisioning + deck-well sets (mirror cDNA_Dynamic_v10.py) ----------
...
def validate_config(cfg, active):
    ...
    (cDNA_Dynamic_v10.py) enforces: capacity, duplicate/illegal RNA positions,
    ...
    == OK. KEEP IN SYNC with cDNA_Dynamic_v10.py's fail-fast asserts."""
    errors = []
