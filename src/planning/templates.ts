...
tube_p300_adjust,-0.45,fine depth for P300 in the 24-well racks (negative = deeper)
...
pool_drain_step2,0.3,STEP 6 drain: extra mm DOWN for the 2nd scavenge pass (total = step1+step2 below contact). OPEN-LOOP: keep above the tube bottom
